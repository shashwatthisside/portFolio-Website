    ...
    return (
        <div className='bg-black h-20 flex justify-between items-center w-full text-white fixed top-0 z-50'>
            ...
            <ul className=' hidden md:flex'>
                <li className='cursor-pointer font-medium text-gray-300 text-lg capitalize hover:scale-125 duration-200 hover:text-red-500 gap-9 px-4 '><Link to='home' smooth duration={800}>HOME</Link></li>
...

            {
                nav && (
                    <ul className='flex flex-col justify-center items-center absolute w-full h-screen bg-gradient-to-b from-black via-black to-gray-800 top-0 left-0 right-0 bottom-0 gap-5'>
                        <li className='capitalize cursor-pointer text-2xl hover:scale-125 duration-200 gap-3 text-gray-300 hover:text-red-500  '><Link onClick={() => setNav(!nav)} to='home' smooth duration={800}>HOME</Link></li>
